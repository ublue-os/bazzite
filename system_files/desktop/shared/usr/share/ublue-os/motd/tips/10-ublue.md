It is **always** better to install packages with Distrobox rather than layer them with rpm-ostree. `ujust distrobox` makes it easy!~[More info](https://docs.bazzite.gg/Installing_and_Managing_Software/Distrobox/)
