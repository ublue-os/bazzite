...
There is more information about this topic on the [Installation Guide](https://universal-blue.discourse.group/docs?topic=30) to help guide users on which image to choose before the installation. 
