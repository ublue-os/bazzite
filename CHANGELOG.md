...
* add automatically generated changelogs ([#1767](https://github.com/ublue-os/bazzite/issues/1767)) ([34c51f1](https://github.com/ublue-os/bazzite/commit/34c51f16a1d46d3a9a2eddc18d550dd0e28f6623))
* Add Clapgrep as a default application. Great file search with a 100% on-brand icon & name ([5b42e33](https://github.com/ublue-os/bazzite/commit/5b42e33adda572e9a64877ddcd886d365c608478))
...
* Add offline documentation ([#1530](https://github.com/ublue-os/bazzite/issues/1530)) ([4155b56](https://github.com/ublue-os/bazzite/commit/4155b5643f8753892105af995611cf3212b7ae84))
* Add rar archive support ([3e4e162](https://github.com/ublue-os/bazzite/commit/3e4e1629563f35283d911eb15062fe03b064f0e4))
...
* **ally x:** add convolver for Ally X ([e3eefe9](https://github.com/ublue-os/bazzite/commit/e3eefe9a92d5dec11ed83b1b7250d684ebdd7aaf))
...
* **deck:** Add new gamescope display definition for the Legion Go ([de6ba1f](https://github.com/ublue-os/bazzite/commit/de6ba1fe62d6f8fb852e36c47146d92e1bd9067a))
...
* **gamescope:** Add Ally display patch and bicubic filter patch ([12e5081](https://github.com/ublue-os/bazzite/commit/12e50816187636472965ba05bca2c4d57b75f0b7))
* **gamescope:** Add Ally display patch and bicubic filter patch, use master branch for now ([087ab50](https://github.com/ublue-os/bazzite/commit/087ab5079e5ccf0a47dce7ff87eb76551eec6d95))
* **gamescope:** Add Ally display patch and bicubic filter patch, use master branch for now ([af99af2](https://github.com/ublue-os/bazzite/commit/af99af20a4403523163a18f888f944facbcc55ba))
* **gamescope:** Add Ally display patch and bicubic filter patch, use master branch for now ([a6f0015](https://github.com/ublue-os/bazzite/commit/a6f001532732a43b1d43df281081a9e80fc488d7))
* **gamescope:** prepare to start tracking upstream + cleanup ([#1736](https://github.com/ublue-os/bazzite/issues/1736)) ([d3ba14a](https://github.com/ublue-os/bazzite/commit/d3ba14aefa671691b626acee04ad1c6267b2c1ec))
...
* **gnome:** Enable Xwayland fractional scaling ([a6bade5](https://github.com/ublue-os/bazzite/commit/a6bade5ccd35b6ef4c060e8f25da77e548f96cac))
...
* **nvidia:** Add vdpau packages for Mesa from negativo17 ([f5553ab](https://github.com/ublue-os/bazzite/commit/f5553ab7f206a508c160f795602a466a96d7140b))
...
* Remove Konsole & GNOME Terminal to save space in-image ([#1550](https://github.com/ublue-os/bazzite/issues/1550)) ([ee89f5f](https://github.com/ublue-os/bazzite/commit/ee89f5f76b665d90dc63dd8d7e5445ff35db7c29))
...
* Switch to Protontricks Flatpak ([316888f](https://github.com/ublue-os/bazzite/commit/316888f341e99eb92a657ee0fdafbc53ef6f8fad))
...
* **ujust:** add pwfeedback toggle ([#1765](https://github.com/ublue-os/bazzite/issues/1765)) ([4d8f65e](https://github.com/ublue-os/bazzite/commit/4d8f65e90ccc82114c0482d1d0a57c4ea8c8fcf7))
...
* update gamescope patches with new features ([#1768](https://github.com/ublue-os/bazzite/issues/1768)) ([d5e78ae](https://github.com/ublue-os/bazzite/commit/d5e78ae76a16ad98b9d2069a9adf72420a91b0b4))
...
* **changelogs:** fix ref target in changelogs ([#1780](https://github.com/ublue-os/bazzite/issues/1780)) ([b739d45](https://github.com/ublue-os/bazzite/commit/b739d459eab7514ebf9e0dfd3bed7584a049b926))
...
* Correct issue with steam web debug service ([a14d6cb](https://github.com/ublue-os/bazzite/commit/a14d6cb4fed75aba2c5a0297e197efdc3dd3353d))
...
* **deck:** Further power consumption adjustments for deck hardware ([8dba403](https://github.com/ublue-os/bazzite/commit/8dba40354bd934fbe350ade648a9a5f6528e0159))
* **deck:** Remove branch selector on reboot ([ea28269](https://github.com/ublue-os/bazzite/commit/ea2826946280442e93bc06ce0e22b152af936991))
* **deck:** Remove upstream wifi firmware due to https://bugzilla.kernel.org/show_bug.cgi?id=218872 ([394b179](https://github.com/ublue-os/bazzite/commit/394b179e51f1e4ff41400e3a0cf89b7095fabd69))
* **deck:** Use super + 1/2 for Overlay/QAM ([#1724](https://github.com/ublue-os/bazzite/issues/1724)) ([cb4cddb](https://github.com/ublue-os/bazzite/commit/cb4cddb168aefbacc05e616df3a05f310e4fe705))
...
* Disable displaylink by default, now can be enabled with `ujust enable-displaylink`. ([410f13b](https://github.com/ublue-os/bazzite/commit/410f13ba876404e5f5e40a2dabcb7c78055a90ff))
* Disable tailscale by default, now can be enabled with `ujust enable-tailscale` ([97fc18d](https://github.com/ublue-os/bazzite/commit/97fc18dc93844844eb46fe815f1b44990d304ce3))
...
* Downgrade to 6.9.x kernel temporarily due to issues with UMA buffer size on some handhelds ([de1a1c1](https://github.com/ublue-os/bazzite/commit/de1a1c14da258fc90bf1d2c0f043691efbd57641))
...
* Error build on gschema name glob ([cc6831e](https://github.com/ublue-os/bazzite/commit/cc6831ef67e645b9a49f165406763b966b3f4991))
* Forgot to add compiling gschema in Containerfile ([0806334](https://github.com/ublue-os/bazzite/commit/0806334c88e6a976ee3b001c579c240a3cb4194c))
...
* Justfile syntax complains ([5bcfd7a](https://github.com/ublue-os/bazzite/commit/5bcfd7ac46837cfca836be12dd797a576ea2d80a))
...
* **legion go:** remove lcd script ([#1745](https://github.com/ublue-os/bazzite/issues/1745)) ([11f1577](https://github.com/ublue-os/bazzite/commit/11f15772e90ae6ccaaad4e95dad3f4e4e96420e2))
...
* Move memory settings to tuned ([b2e4c8b](https://github.com/ublue-os/bazzite/commit/b2e4c8bb13edcf4eb2a5f3af527a1a098313d1ba))
* **nvidia:** Re-enable GSP firmware ([8faadd9](https://github.com/ublue-os/bazzite/commit/8faadd9400c97e9a40b80dd7f51b40ffc978e320))
* Properly edit `dconf` to load all files at once ([8c58468](https://github.com/ublue-os/bazzite/commit/8c58468229e6b82c8853d7db5e6fc090192e69a8))
...
* Restoring gnome folders just dconf ([2be7b50](https://github.com/ublue-os/bazzite/commit/2be7b50845ec8d05007c268072c95da3ce0fba1e))
...
* **steam:** Add shortcut to start Steam BPM without slugishness ([#1754](https://github.com/ublue-os/bazzite/issues/1754)) ([bc883a4](https://github.com/ublue-os/bazzite/commit/bc883a461034ccd82e1f92e6db29e8104a61cebd))
* temporarily disable "turn off screen when idle" in kde for handhelds ([#1771](https://github.com/ublue-os/bazzite/issues/1771)) ([a8a9513](https://github.com/ublue-os/bazzite/commit/a8a9513b07cb51af0e6bab9700ae763ab443ebf6))
...
* Turn off some Lutris options by default to ease user confusion ([1b3c35f](https://github.com/ublue-os/bazzite/commit/1b3c35f9f4b50fe2014c5237966bbe02f876d0e6))
* update bazzite-rollback-helper list to capture new image tags ([#1503](https://github.com/ublue-os/bazzite/issues/1503)) ([af4a669](https://github.com/ublue-os/bazzite/commit/af4a66916564a358c9debeabbe6f58a9769b765c))
